...
//    }
    ...
    public function getManagers() {
        return Yii::app()->getModule('user')->getManagers();
    }
    ...
    public function isMarketer() {
        return Yii::app()->getModule('user')->isMarketer();
    }

    public function isClient() {
        return Yii::app()->getModule('user')->isClient();
    }

    public function getClients($id=0) {
        return Yii::app()->getModule('user')->user($id)->client;
    }

    public function getClientUsers() {
        return Yii::app()->getModule('user')->getClientUsers();
    }

    public function respondentsInGroups($id = 0){
        return Yii::app()->getModule('user')->user($id)->respondentsInGroups;
    }
