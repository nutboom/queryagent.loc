                ...
                <div class="tariffs">
                	<label>
                		...
                		<img src="/images/base.png">
               			<div class="cost"><span><?php echo Ceil(Tariffs::model()->findByPk(2)->cost); ?> руб.</span> в месяц</div>
                		<input type="radio" name="Licenses[tariff]" value="2" class="nc_iCheck">
                	</label>
                	...
                	<label>
                		...
                		<input type="radio" name="Licenses[tariff]" value="4" class="nc_iCheck" checked>
                	</label>
                </div>
