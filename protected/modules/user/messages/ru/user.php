...
return array(
	...
	'Replenishment Balance' => 'Пополнение баланса',
	'Sub Users' => 'Суб. пользователи',
	'Create Sub User' => 'Создать суб. пользователя',
	'Inform mail for sub sub user' => 'Для входа в аккаунт используйте следующие данные:<br>Url: {url}<br>Логин: {login}<br>Пароль: {password}',
	'New sub user successfully created' => 'Новый суб. пользователь успешно создан',
	'List of Sub User' => 'Список',
	...
	'You have requested the password recovery site {site_name}' => 'Восстановление пароля с сайта {site_name}',
	'You have requested the password recovery site {site_name}. To receive a new password, go to {activation_url}.' => 'Вы запросили восстановление пароля на сайте {site_name}.<br />Для восстановления пароля перейдите по ссылке: <a href="{activation_url}">{activation_url}</a>.',
	...
	'You account is active.' => 'Ваша учетная запись уже активирована.<br /><a href="/login">Вход для клиентов</a>',
	'You account is activated.' => 'Ваша учетная запись активирована.<br /><a href="/login">Вход для клиентов</a>',
    ...
    'Client' => 'Клиент',
    'Clients user' => 'Клиенты пользователя',
    'Marketer' => 'Менеджер опросов по группам пользователей',
    'Changes is saved.' => 'Изменения сохранены.',
    'The maximum number of clients' => 'Ваш тарифный план предполагает не более {max} клиентов',
);
