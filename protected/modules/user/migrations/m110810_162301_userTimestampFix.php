	...
	public function safeUp()
	{
        ...
        switch ($this->dbType()) {
            ...
            default:
                    ...
                    $this->execute('INSERT INTO "'.Yii::app()->getModule('user')->tableUsers.'" SELECT "id","username","password","email","activkey","superuser","manager","status","create_at","lastvisit_at" FROM "'.__CLASS__.'_'.Yii::app()->getModule('user')->tableUsers.'"');
	...
	public function safeDown()
	{
        ...
        switch ($this->dbType()) {
            ...
            default:
                ...
                $this->execute('INSERT INTO "'.Yii::app()->getModule('user')->tableUsers.'" SELECT "id","username","password","email","activkey","createtime","lastvisit","superuser","manager","status" FROM "'.__CLASS__.'_'.Yii::app()->getModule('user')->tableUsers.'"');
