...
class m110805_153437_installYiiUser extends CDbMigration
{
	...
	public function safeUp()
	{
        ...
        switch ($this->dbType()) {
            case "mysql":
                    ...
                    $this->createTable(Yii::app()->getModule('user')->tableClients, array(
                        'id' 	=> 'pk',
                        'name' 	=> 'string',
                    ), $this->MySqlOptions);

                    $this->createTable(Yii::app()->getModule('user')->tableUsersClients, array(
                        'users_id'      => 'INT',
                        'clients_id' 	=> 'INT',
                    ), $this->MySqlOptions);
                    $this->addForeignKey('user', Yii::app()->getModule('user')->tableUsersClients, 'users_id', Yii::app()->getModule('user')->tableUsers, 'id', 'NO ACTION', 'NO ACTION');
                    $this->addForeignKey('client', Yii::app()->getModule('user')->tableUsersClients, 'clients_id', Yii::app()->getModule('user')->tableClients, 'id', 'NO ACTION', 'NO ACTION');
                break;
	...
	{
        $this->dropTable(Yii::app()->getModule('user')->tableUsersClients);
        $this->dropTable(Yii::app()->getModule('user')->tableClients);
