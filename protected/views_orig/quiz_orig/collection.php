...
?>
	...
	<div class="step-pane">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<label class="col-sm-12 control-label nCLeft-text"><?php echo Yii::t('app', 'Web link'); ?></label>
			</div>

			<div class="col-sm-7">
				<input type="text" value="http://panel.queryagent.ru/?h=<?php echo $model->hash; ?>" class="form-control" id="textlink" style="width: 90%; margin-right: 20px; float: left;" />
                ...
                if($bitly['status_code'] == 200 && $bitly['status_txt'] == 'OK')
                {
                    ...
                    echo "<div style='float:left;margin-right:20px;'>Короткая ссылка - <span id='short_text'>".$short_ly."</span></div>";
                    ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<label class="col-sm-12 control-label nCLeft-text"><?php echo Yii::t('app', 'Window quiz in your site'); ?></label>
			</div>
		...
		<div class="form-group">
			<div class="col-sm-2">
				<?php $this->widget('bootstrap.widgets.TbButton', array(
					'buttonType'=>'link',
					'type'=>'primary',
					'url'=>array('/'.$model->type.'/'.$model->quiz_id.'/StructureQuiz'),
