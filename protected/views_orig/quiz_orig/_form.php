	...
	<div class="step-pane">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				...
				<div class="col-sm-4" id="show_client">
    				<?php if($model->client): ?>
                        <p><?php echo $model->client->name; ?></p>
                     <?php endif; ?>
				</div>
				<div class="col-sm-5">
			...
			<div class="form-group">
				<div class="col-sm-10">
					<div class="radio nCRight green">
						...
						<label>
							<?php echo CHtml::checkBox('Quiz[archive]', $model->needs_confirmation, array('class'=>'icheck right')); ?>
		...
		<div class="form-group">
			<div class="col-sm-2">
				...
				<?php if ($model->state == Quiz::STATE_EDIT && $model->quiz_id): ?>
					<?php $this->widget('bootstrap.widgets.TbButton', array(
