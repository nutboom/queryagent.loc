<?php
$this->pageTitle=Yii::app()->name . ' / '.Yii::t('app', ucfirst($quiz->type).'s') . ' / '.Yii::t('app','Target audience') . ' / '.Yii::t('app','Create');
...
<?php echo $this->renderPartial('_form', array('model'=>$model, 'client'=>$quiz->client_id, 'quiz'=>$quiz, 'formtype'=>'create')); ?>